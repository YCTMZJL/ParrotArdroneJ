...
else
{
    ...
    //printf("startcount = %d \n", startcount);
      ...
      /////////////////////////////////////////////////////////////////////////////////////Step 1
      if(startcount  > Stage1time && startcount  <= Stage2time ) { //right 
      	stick1LR = center_x1 + 8000 ;  // right
      }
     else if(startcount > Stage2time  && startcount <= Stage3time ) { //xuanting
      	stick1UD = center_y1; 
      	stick1LR = center_x1;
      }
      else if(startcount > Stage3time  && startcount <= Stage4time ) { // qianjin+right
      ...
      else if(startcount >  Stage7time && startcount <= Stage8time ) //qianjin+left
      {
      	stick1UD = center_y1 - 9000;//qianjin
      	stick1LR = center_x1 -9000;//left
      }
      ...
      else if(startcount >  Stage9time && startcount <= Stage10time ) //left
      {
      ...
      else if(startcount >  Stage11time && startcount <= Stage12time ) //left+hotui
      {
      	stick1LR = center_x1 - 9000;//left
      	stick1UD = center_y1 + 9000;//houtui
      }
      ...
      else if(startcount >  Stage13time && startcount <= Stage14time ) //houtui
      {
      ...
      else if(startcount >  Stage15time && startcount <= Stage16time ) //houtui + right
      {
      	stick1LR = center_x1 + 9000;//right
      	stick1UD = center_y1 + 9000;//houtui
      }
      else if(startcount >  Stage16time)//xuanting
      {
      	stick2UD = center_y2 ;
      	stick1LR = center_x1 ; 
      	stick1UD = center_y1 ; 
