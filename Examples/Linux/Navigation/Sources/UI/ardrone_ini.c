...
static int autoflyflag =  1; //zidong=1 shoudong  =0 ###############################
...
}//related to res!=-1?// autoflyflag != -1
else
{
    stick1LR = center_x1;
    stick1UD = center_y1;
    ...
    //printf("startcount = %d \n", startcount);
      ...
      /////////////////////////////////////////////////////
        // from the head of the level sorrow
      int Stage2time = Stage1time + 60 ;//move // right + qianjin
      int Stage3time = Stage2time + 250;//xuanting
      int Stage4time = Stage3time + 35 ;//move // left
      int Stage5time = Stage4time + 250 ;//xuanting
      int Stage6time = Stage5time + 65 ;//move //qianjin 
      int Stage7time = Stage6time + 250;//xuanting
      int Stage8time = Stage7time + 65;//move // up
      int Stage9time = Stage8time + 250;//xuanting
      int Stage10time = Stage9time + 65;//move//qianjin
      int Stage11time = Stage10time + 250;//xuanting
      int Stage12time = Stage11time + 65;//move //left
      int Stage13time = Stage12time + 250;//xuanting
      int Stage14time = Stage13time + 65;//move //back
      int Stage15time = Stage14time + 250;//xuanting
      int Stage16time = Stage15time + 65;//down
      int Stage17time = Stage16time + 250;//xuanting
      int Stage18time = Stage17time + 65;//back
      int Stage19time = Stage18time + 250;//xuanting
      int Stage20time = Stage19time + 35;//left
      int Stage21time = Stage20time + 250;//xuanting
      int Stage22time = Stage21time + 60;//right + back



      
      /////////////////////////////////////////////////////////////////////////////////////Step 1
      if(startcount  > Stage1time && startcount  <= Stage2time ) { //l right + qianjin
      	stick1UD = center_y1 - 9000;//qianjin
      	stick1LR = center_x1 + 9000 ;  // right
      }
      	...
      	stick1LR = center_x1 - 8000 ;  // left
      }
     else if(startcount >  Stage4time && startcount <= Stage5time ) //xuanting
      {   
              stick1LR = center_x1 ;//
      }
      else if(startcount >  Stage5time && startcount <= Stage6time ) //qianjin 
      {
      	stick1UD = center_y1 - 8000;//qianjin
      	//stick1LR = center_x1 + 9000 ;  // right
      }
      ...
      else if(startcount >  Stage7time && startcount <= Stage8time ) //up
      {
      	stick2UD = center_y2 - 8000;//up
      }
      else if(startcount >  Stage8time && startcount <= Stage9time ) //xuanting
      {
      	stick2UD = center_y2; 
      }
      else if(startcount >  Stage9time && startcount <= Stage10time ) //qianjin
      {
      	stick1UD = center_y1 -  8000;//qianjin
      }
      ...
      else if(startcount >  Stage13time && startcount <= Stage14time ) //back 
      {
      	stick1UD = center_y1 + 8000;//back
      	//stick1LR = center_x1 + 9000 ;  // right
      }
      ...
      else if(startcount >  Stage15time && startcount <= Stage16time ) //down
      {
      	stick2UD = center_y2 + 8000;//down
      	//stick1LR = center_x1  ; 
      }
      else if(startcount >  Stage16time && startcount <= Stage17time ) //xuanting
      {
      	stick2UD = center_y2 ;//xuanting
      	//stick1LR = center_x1  ; 
      }
      else if(startcount >  Stage17time && startcount <= Stage18time ) //back
      {
      	stick1UD = center_y1 + 8000;//back
      	//stick1LR = center_x1  ; 
      }
      else if(startcount >  Stage18time && startcount <= Stage19time ) //xuanting
      {
      	stick1UD = center_y1 ;//xuanting      	//stick1LR = center_x1  ; 
      }
      else if(startcount >  Stage19time && startcount <= Stage20time ) //left
      {
      	stick1LR = center_x1 - 8000;//left
      }
      else if(startcount >  Stage20time && startcount <= Stage21time ) //xuanting
      {
      	stick1LR = center_x1 ;//xuanting
      }
      else if(startcount >  Stage21time && startcount <= Stage22time ) //right + back
      {
      	stick1UD = center_y1 + 9000;//back
      	stick1LR = center_x1 + 9000;//right
      }
      else if(startcount >  Stage22time)//xuanting
      {
      	stick2UD = center_y2 ;
      	stick1LR = center_x1 ; 
      	stick1UD = center_y1 ; 
     ...
     /* else if(startcount >  Stage29time && startcount <= Stage30time ) // up
      {
              stick2UD = center_y2 - 7500;
      }
      else if(startcount >  Stage30time && startcount <= Stage31time ) //xuanting
      {
              stick2UD = center_y2 ;
      }
      ////////////////////////////////////////////////////////
      else if(startcount >  Stage31time)
      {
      	autoflyflag = 0;
      }*/
}
