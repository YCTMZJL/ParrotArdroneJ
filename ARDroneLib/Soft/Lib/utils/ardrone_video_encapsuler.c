...
struct videoGpsInfos_s videoGpsInfos_6_12; 
FILE* gps2016 = NULL; 
//gps2016=fopen("gps2016.txt","wb");
...
{
    gps2016 = fopen("gps2016.txt","wb");//NULL;
#ifdef USE_ELINUX
    int fd;
#endif
...
int generateGpsString (char *gpsBuffer, int bufferSize)
{
    ...
    //fopen(gps2106,"wb");
    printf ("GPSlatitud: %+.4f GPSlongitude: %+.4f GPSaltitude:%+.3f\n", videoGpsInfos.latitude, videoGpsInfos.longitude, videoGpsInfos.altitude);
    fprintf (gps2016,"GPSlatitud: %+.4f GPSlongitude: %+.4f GPSaltitude:%+.3f\n", videoGpsInfos.latitude, videoGpsInfos.longitude, videoGpsInfos.altitude);
