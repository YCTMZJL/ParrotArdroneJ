...
//#ifdef STREAM_WIDTH
//#undef STREAM_WIDTH
//#define STREAM_WIDTH (hdtv720P_WIDTH)
//#endif
//#ifdef STREAM_HEIGHT
//#undef STREAM_HEIGHT
//#define STREAM_HEIGHT (hdtv720P_HEIGHT)
//#endif
//
...
C_RESULT ardrone_tool_init_custom(void) {
    ...
    if (IS_ARDRONE2)
    {
        ardrone_application_default_config.video_codec = H264_360P_CODEC; //H264_720P_CODEC;//  H264_360P_CODEC;
    ...
    gtkconf.desired_display_width   = 0;//STREAM_WIDTH;  /* auto */
    gtkconf.desired_display_height  = 0;//STREAM_HEIGHT;  /* auto */
