...
double getmstime2_double()
{
	struct timeval tv;
	gettimeofday(&tv,NULL);
	double timems =  tv.tv_usec/1000;
	return timems;
}//
...
NeedInfo_2016 NeedInfo_6_12;
NeedInfo_2016 NeedInfo_fromnavdata_1122;
//////////////////////////////
...
FILE* record_file_2016 = NULL;//for record data to see whether it is avilable
...
static void ardrone_navdata_file_print_version( void )
{
  ...
  "TimeInv (s); Control_state [-]; ARDrone_state [-]; Time [s]; nd_seq_num [-]; \
...
C_RESULT ardrone_navdata_file_init( void* data )
{
  ...
  //File* record_file_2016 = fopen
  char myfilename[1024];
  sprintf(myfilename,"result2016/record_file_%04d%02d%02d_%02d%02d%02d.txt",
 	navdata_atm->tm_year+1900, navdata_atm->tm_mon+1, navdata_atm->tm_mday,
        navdata_atm->tm_hour, navdata_atm->tm_min, navdata_atm->tm_sec);
  record_file_2016 = fopen(myfilename,"wb");
...
C_RESULT ardrone_navdata_file_process( const navdata_unpacked_t* const pnd )
{
	...
	//time record
	time_t temptime = (time_t)time.tv_sec;
  	navdata_atm = localtime(&temptime);
	...
	//navdata_atm->tm_year+1900, navdata_atm->tm_mon+1, navdata_atm->tm_mday,
        //navdata_atm->tm_hour, navdata_atm->tm_min, navdata_atm->tm_sec
	//record time
	fprintf(record_file_2016,
	"\nTimeRecord: %04d%02d%02d_%02d%02d%02d_%ld\n",
	navdata_atm->tm_year+1900, navdata_atm->tm_mon+1, navdata_atm->tm_mday,
        navdata_atm->tm_hour, navdata_atm->tm_min, navdata_atm->tm_sec,//navdata_atm->tm_sec)
	getmstime());////////////////*/

	fprintf( navdata_file,"\n" );
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//for record time
	double cursec = getsec();
	fprintf(navdata_file,
	" %lf;",
	cursec - inisec);//////////////////getmstime());//
	inisec = cursec;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	NeedInfo_fromnavdata_1122.GyrosX =  ((double) pnd->navdata_phys_measures.phys_gyros[GYRO_X]);
	NeedInfo_fromnavdata_1122.GyrosY =  ((double) pnd->navdata_phys_measures.phys_gyros[GYRO_Y]);
	NeedInfo_fromnavdata_1122.GyrosZ =  ((double) pnd->navdata_phys_measures.phys_gyros[GYRO_Z]);
	NeedInfo_fromnavdata_1122. AccX= ((double) pnd->navdata_phys_measures.phys_accs[ACC_X]);
	NeedInfo_fromnavdata_1122. AccY= ((double) pnd->navdata_phys_measures.phys_accs[ACC_Y]);
	NeedInfo_fromnavdata_1122. AccZ= ((double) pnd->navdata_phys_measures.phys_accs[ACC_Z]);
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/*printf("raw_gyros[X]: %04d;raw_gyros[Y]: %04d;raw_gyros[Z]: %04d;raw_gyros_110[0]: %04u;raw_gyros_110[1]: %04u;\n",
	(int) pnd->navdata_raw_measures.raw_gyros[GYRO_X],
	(int) pnd->navdata_raw_measures.raw_gyros[GYRO_Y],
	(int) pnd->navdata_raw_measures.raw_gyros[GYRO_Z],
	(unsigned int) pnd->navdata_raw_measures.raw_gyros_110[0],
	(unsigned int) pnd->navdata_raw_measures.raw_gyros_110[1]);///////////////////////////////////////////////////*/
        ...
        //give value
        NeedInfo_6_12.raw_gyros_X2016=(int)pnd->navdata_raw_measures.raw_gyros[GYRO_X];
        NeedInfo_6_12.raw_gyros_Y2016=(int)pnd->navdata_raw_measures.raw_gyros[GYRO_Y];
        NeedInfo_6_12.raw_gyros_Z2016=(int)pnd->navdata_raw_measures.raw_gyros[GYRO_Y];
	//record_file_2016
 	fprintf(record_file_2016,"raw_gyros[X]:%04d;raw_gyros[Y]:%04d;raw_gyros[Z]:%04d;raw_gyros_110[0]:%04u;raw_gyros_110[1]:%04u;\n",
	(int) pnd->navdata_raw_measures.raw_gyros[GYRO_X],
	(int) pnd->navdata_raw_measures.raw_gyros[GYRO_Y],
	(int) pnd->navdata_raw_measures.raw_gyros[GYRO_Z],
	(unsigned int) pnd->navdata_raw_measures.raw_gyros_110[0],
	(unsigned int) pnd->navdata_raw_measures.raw_gyros_110[1]);/////record into file
	...
	/*printf( "magneto.mx: %5d;magneto.my: %5d;magneto.mz: %5d;magneto_raw.x: %6f;magneto_raw.y: %6f;magneto_raw.z: %6f;magneto_rectified.x: %6f;magneto_rectified.y: %6f;magneto_rectified.z: %6f\n",
			(signed int) pnd->navdata_magneto.mx,
			(signed int) pnd->navdata_magneto.my,
			(signed int) pnd->navdata_magneto.mz,
			pnd->navdata_magneto.magneto_raw.x,
			...
			pnd->navdata_magneto.magneto_rectified.z);/////////////////*/
        //record_file_2016
        fprintf( record_file_2016,"magneto.mx: %5d;magneto.my: %5d;magneto.mz: %5d;magneto_raw.x: %6f;magneto_raw.y: %6f;magneto_raw.z: %6f;magneto_rectified.x: %6f;magneto_rectified.y: %6f;magneto_rectified.z: %6f\n",
			(signed int) pnd->navdata_magneto.mx,
			(signed int) pnd->navdata_magneto.my,
			(signed int) pnd->navdata_magneto.mz,
			pnd->navdata_magneto.magneto_raw.x,
	...
	/*printf( "magneto_offset.x: %6f;magneto_offset.y: %6f;magneto_offset.z: %6f;heading_unwrapped: %6f;heading_gyro_unwrapped: %6f;heading_fusion_unwrapped: %6f\n",
			pnd->navdata_magneto.magneto_offset.x,
			pnd->navdata_magneto.magneto_offset.y,
			pnd->navdata_magneto.magneto_offset.z,
			pnd->navdata_magneto.heading_unwrapped,
			...
			pnd->navdata_magneto.heading_fusion_unwrapped);///////////////////*/
        //record_file_2016
        fprintf(record_file_2016,"magneto_offset.x: %6f;magneto_offset.y: %6f;magneto_offset.z: %6f;heading_unwrapped: %6f;heading_gyro_unwrapped: %6f;heading_fusion_unwrapped: %6f\n",
			pnd->navdata_magneto.magneto_offset.x,
			pnd->navdata_magneto.magneto_offset.y,
			pnd->navdata_magneto.magneto_offset.z,
			pnd->navdata_magneto.heading_unwrapped,
	...
	/*printf("magneto_calibration_ok: %d;magneto_state: %d;magneto_radius:  %6f;magneto.error_mean: %6f;magneto.error_var: %6f;wind_speed.magneto_debug1: %6f;wind_speed.magneto_debug2: %6f;wind_speed.magneto_debug3 %6f\n",
			pnd->navdata_magneto.magneto_calibration_ok,
			pnd->navdata_magneto.magneto_state,
			pnd->navdata_magneto.magneto_radius,
			pnd->navdata_magneto.error_mean,
			...
			pnd->navdata_wind_speed.magneto_debug3);//////////////////////*/
        //record_file_2016
        fprintf(record_file_2016,"magneto_calibration_ok: %d;magneto_state: %d;magneto_radius:  %6f;magneto.error_mean: %6f;magneto.error_var: %6f;wind_speed.magneto_debug1: %6f;wind_speed.magneto_debug2: %6f;wind_speed.magneto_debug3 %6f\n",
			pnd->navdata_magneto.magneto_calibration_ok,
			pnd->navdata_magneto.magneto_state,
			pnd->navdata_magneto.magneto_radius,
			pnd->navdata_magneto.error_mean,
	...
	/*printf( "gyros_offsets.offset_g[GYRO_X]: % f;[Y]: % f;[Z]: % f\n",
			pnd->navdata_gyros_offsets.offset_g[GYRO_X],
			pnd->navdata_gyros_offsets.offset_g[GYRO_Y],
			pnd->navdata_gyros_offsets.offset_g[GYRO_Z] );/////////////////*/
//record_file_2016
        fprintf( record_file_2016,"gyros_offsets.offset_g[GYRO_X]: % f;[Y]: % f;[Z]: % f\n",
			pnd->navdata_gyros_offsets.offset_g[GYRO_X],
			pnd->navdata_gyros_offsets.offset_g[GYRO_Y],
			pnd->navdata_gyros_offsets.offset_g[GYRO_Z] );/////////////////
...
C_RESULT ardrone_navdata_file_release( void )
{
  if( navdata_file != NULL )
  {
    ...
    fclose( record_file_2016);

    record_file_2016=NULL;
